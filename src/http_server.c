...
"function fy(b){if(b==null||b<0)b=0;if(yUnit==='b')return fmtInt(b)+' B';if(yUnit==='mb')return b>=1048576?(b/1048576).toFixed(2)+' MB':(b/1024).toFixed(1)+' KB';return b>=1024?fmtInt(b/1024)+' KB':fmtInt(b)+' B'}\n"
